...
const [a4, mobile] = await Promise.all([
  put("pdf/revision-0/catalogo-a4-inicial.pdf", fs.readFileSync("Vestalia_Catalogo_Cafeterias.pdf"), { access: "public", contentType: "application/pdf", addRandomSuffix: false }),
  put("pdf/revision-0/catalogo-movil-inicial.pdf", fs.readFileSync("Vestalia_Catalogo_Movil.pdf"), { access: "public", contentType: "application/pdf", addRandomSuffix: false })
]);
